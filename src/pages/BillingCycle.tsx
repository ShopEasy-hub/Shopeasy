    ...
    try {
      ...
      const result = await initializePayment(
        selectedProvider,
        {
          ...
          currency: 'NGN',
          reference,
          callback_url: callbackUrl, // Dynamic callback URL for Figma Make
          metadata: {
      ...
      console.log('💾 Stored pendingPayment in sessionStorage:', {
        reference,
        provider: selectedProvider,
        planId: selectedPlan.id,
        billingCycle: selectedCycle,
      ...
      // Also store in localStorage as backup (persists across external redirects)
