...
export function PaymentVerification({
  ...
  async function verifyPaymentStatus() {
    ...
    try {
      console.log('🔍 [PaymentVerification] Starting verification (NO AUTH REQUIRED)');
      console.log('🔍 [PaymentVerification] Provider:', provider);
      console.log('🔍 [PaymentVerification] Reference:', reference);

      // Wait a bit for payment to process
      await new Promise((resolve) => setTimeout(resolve, 2000));

      console.log('🔍 [PaymentVerification] Calling verifyPayment...');
