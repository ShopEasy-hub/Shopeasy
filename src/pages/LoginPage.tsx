...
export function LoginPage({ onSuccess, onSignUp, onForgotPassword }: LoginPageProps) {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (user) {
        // Fetch user profile to get orgId, role, branchId, warehouseId, and subscription info
        const userProfile = await getUserProfile(user.id);
        
        console.log('User profile:', userProfile);
        
        // Extract organization subscription details
        const org = userProfile.organization;
        const subscriptionPlan = org?.subscription_plan || null;
        const subscriptionStatus = org?.subscription_status || null;
        const trialStartDate = org?.trial_start_date || null;
