...
export default function SuperAdminPanel({ appState, onBack }: SuperAdminPanelProps) {
  ...
  useEffect(() => {
    checkAuthorization();
  }, []); // Removed appState.userId from dependencies to prevent infinite loop
      ...
      <div className="min-h-screen flex items-center justify-center bg-background">
        <Card className="max-w-md">
          ...
          <CardContent>
            ...
            <Button className="w-full mt-4" onClick={() => onBack && onBack()}>
              Back to Dashboard
            </Button>
          </CardContent>
        </Card>
